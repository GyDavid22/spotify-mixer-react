    ...
    <>
      ...
      <div className='d-flex flex-column gap-1'>       
        ...
        <div>
          ...
          <p>
            This app doesn't use any backend besides the official Spotify APIs. That means your Spotify application credentials are safe and are not forwarded to anyone but Spotify. <b>Every data you input here are stored locally on your computer, using localStorage. Spotify app credentials or any sensitive data are not included in the JSON backup for safety reasons. This app doesn't handle or receive your password in any way, and doesn't have access to anything more than you give permission for when you authenticate the first time.</b>
          </p>
          <h5>
